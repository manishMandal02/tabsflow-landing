...
const FAQSection = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        'TabsFlow works seamlessly with Chrome, Firefox, Safari, and Edge. We provide native extensions for each browser with full feature parity. Installation takes less than 30 seconds on any supported browser.',
      icon: HiGlobe,
    ...
    },
    {
      ...
      answer:
        'Your privacy is our top priority. TabsFlow processes all data locally on your device. Only encrypted sync data (if you choose to enable cloud sync) is stored on our secure servers. We never track your browsing habits or sell your data to third parties.',
      icon: HiShieldCheck,
      category: 'privacy'
    },
    {
      ...
      answer:
        'Yes! TabsFlow offers seamless cloud synchronization across all your devices. Your tabs, notes, workspaces, and preferences sync automatically. You can start work on your laptop and continue on your desktop without missing a beat.',
      icon: HiUsers,
      category: 'sync'
    },
    {
      ...
      answer:
        "TabsFlow combines vertical tab management with a powerful command palette (25+ commands), contextual notes, smart tab snoozing, and advanced productivity features. It's designed specifically for professionals who manage complex workflows with many tabs and need intelligent organization tools.",
    ...
    },
    {
      ...
      answer:
        'Not at all! TabsFlow is designed to feel intuitive from day one. The vertical tab layout is immediately familiar, and the command palette works just like Spotlight or Raycast. Most users are productive within minutes of installation.',
      icon: HiCog,
      category: 'usability'
    },
    {
      ...
      answer:
        "TabsFlow is currently free during our beta period! We're planning a freemium model with basic features free forever and advanced features (unlimited workspaces, advanced analytics, team collaboration) available in our Pro plan for $4.99/month.",
      icon: HiSparkles,
      category: 'pricing'
    },
    {
      ...
      answer:
        'Absolutely! TabsFlow automatically imports your existing bookmarks and can convert browser tab groups into TabsFlow workspaces. The migration process is seamless and preserves all your existing organization.',
      icon: HiCog,
      category: 'migration'
    },
    {
      ...
      answer:
        'We offer comprehensive support including detailed documentation, video tutorials, email support, and live chat during business hours. Our community Discord also provides peer support and feature discussions with the TabsFlow team.',
      icon: HiSupport,
      category: 'support'
    }
  ];
  ...
  const categories = [
    ...
    { id: 'privacy', label: 'Privacy & Security', count: faqs.filter(f => f.category === 'privacy').length },
    {
      id: 'compatibility',
      label: 'Compatibility',
      count: faqs.filter(f => f.category === 'compatibility').length
    },
              ...
              >
                ...
                >
                  ...
                  <div className='flex-1'>
                    <h3 className='font-semibold text-slate-900 text-lg mb-1 pr-4'>{faq.question}</h3>
                  ...
                  {openFAQ === faq.id && (
                    ...
                    >
                      <div className='px-6 pb-6 pt-0'>
                        <div className='ml-14 text-slate-600 leading-relaxed'>{faq.answer}</div>
                      </div>
                    </motion.div>
                  )}
                </AnimatePresence>
        ...
        >
          <div className='grid md:grid-cols-2 gap-8 items-center'>
            ...
            <div className='text-center md:text-right'>
              ...
              <div className='mt-4 text-sm text-slate-500'>Average response time: 2 hours</div>
            </div>
          </div>
        </motion.div>
